...
![diagrama-de-arquitetura.png](./backend/diagrama-de-arquitetura.png)

### Diagrama de Classes da camada model

![diagrama-de-classes.png](./backend/diagrama-de-classes.png)
...
Segue abaixo a a `collection` e `enviroment` para configuração das chamdas dos endpoints do backend pela
aplicação [Postman](https://www.postman.com/downloads/)

[Collection](./documentation/postman/Menu%20Manager.postman_collection.json)

Enviroments:

- [Local](./documentation/postman/Menu%20Manager-Local.postman_environment.json)
